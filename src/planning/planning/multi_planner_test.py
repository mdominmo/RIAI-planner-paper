...
# from multi_rrt_star_planner import choose_and_plan
...
rtt_planner = MultiRRTStarPlanner(
            lower_limit,
            upper_limit,
            STEP_SIZE,
            N_STEPS,
...
results = rtt_planner.choose_and_plan(
    starts, goals, SPEED, obstacles, BIAS_PROB, LIMIT, SPATIAL_TOL, 100.0, CYLINDER_HEIGHT, OBSTACLE_RADIUS
)
